...
def color_hash(video_path, colors=[(255,0,0), (0,255,0), (0,0,255)]):
    ...
    return ''.join(hashes[:10])  # first 10 frames hash snippet

# Test it
hash_snippet = color_hash('video.mp4')  # replace with your path
print(f"Hash snippet: {hash_snippet}")
