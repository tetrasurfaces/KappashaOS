...
## 7. Buffer Wars
Buffer wars are PVC, not PVP. Pulse 3–144 via buffer_pulse.rs, 3 for torrents, 72 for loans, 144 for trades (24+48+24 spacing). No MEV due to delta-p * tick-spacing > fees. Privacy via escrow hole.  
**Demo**:  
```rust
