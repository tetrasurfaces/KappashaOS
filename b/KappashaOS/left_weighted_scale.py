...
def left_weighted_scale(w, bits=16):
    """Compute left-weighted scale based on ternary coeffs, returning tuple (scale, 0, 0)."""
    weights = [3**i for i in range(bits // 4)]  # Adjust for bits
    coeffs = balanced_ternary_coeffs(w, weights)
