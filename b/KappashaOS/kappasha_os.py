...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), 'Kappasha')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), 'hashlet')))
