...
class ThoughtCurve:
    def __init__(self, max_steps=229):
        ...
        self.spiral = self.generate_golden_spiral()  # ← fix: call the real method
        self.current_step = 0
        self.tendon_load = 0.0
        self.gaze_duration = 0.0
        print("ThoughtCurve initialized - golden spiral ready.")
    ...
    def generate_golden_spiral(self):
        ...
        print(f"Generated spiral shape: {spiral.shape}")
        return spiral
